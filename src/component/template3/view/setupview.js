...
const setupview = (data) => {
    ...
    let cek_button = '';
    global.isppob = data.checkout.rincianProduk.is_ppob
    ...
    if(is_scan){  
      ...
      if(is_kontak === true){
        ...
        style_border = 'border-radius-right-8'
      }
    }
    global.dynamic_form_1 = `<div class="col-12 mt-2 dynamic-form">
        <div class="multi">
            <div class="row">
                ...
                <input type="text" onkeypress="return isNumber(event,this);" class="form-control shadow-none border-radius-left-8 font-large-1 text-secondary nomor ${style_border}" placeholder="${hint}" aria-label="Nomor User" inputmode="${keyboard_mode}"  aria-describedby="inptNomor" autocomplete="off" />
                ${scan_mode}
                </div>
    ...
    let footer_button = `<div class="col-12 px-1">
    ${cek_button}
    </div>
    `
