...
const setup_footer = () => {
  ...
  const svgFavorite = `
  <svg id="Layer_x0020_1" onclick="favorite()" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 38.232 38.232">
    <defs>
  ...
  `;
  const svgTerjadwal = `
  <svg onclick="terjadwal()" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 38.232 38.232">
